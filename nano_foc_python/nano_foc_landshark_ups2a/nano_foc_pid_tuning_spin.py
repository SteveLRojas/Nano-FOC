...
def main():
	...
	phi_source = 3	#ol_phi, scaled_abz_phi routed to extrapolator
	...
	nano.write_reg(nano.regs.R_FLUX_KP, 800)    #set flux kp
	nano.write_reg(nano.regs.R_FLUX_KI, 30)    #set flux ki
	nano.write_reg(nano.regs.R_FLUX_KD, 0)    #set flux kd
	nano.write_reg(nano.regs.R_TORQUE_TARGET, 0x0000)
	nano.write_reg(nano.regs.R_TORQUE_KP, 800)    #set torque kp
	nano.write_reg(nano.regs.R_TORQUE_KI, 30)    #set torque ki
	nano.write_reg(nano.regs.R_TORQUE_KD, 0)    #set torque kd
	...
	nano.write_reg(nano.regs.R_FLUX_TARGET, 2000)
